...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .mvcMatchers(HttpMethod.GET, "/suppliers/**").permitAll() // GET requests don't need auth
                .anyRequest()
                .authenticated()
                .and()
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:8080", "http://project-2-team-1-frontend-ucllteam16.ucll-ocp-40cb0df2b03969eabb3fac6e80373775-0000.eu-de.containers.appdomain.cloud"));
